...
// Fetch category ID for "Network" from the database
$category_id = null;
$category_query = $conn->prepare("SELECT id FROM categories WHERE name = 'Network'");
...
<body>
    ...
    <main class="content">
        <h2 class="section-title">Network Security Courses</h2>
                    ...
                    <div class="simulation-card">
                        <div class="simulation-header">
                            ...
                            <?php if ($course['is_enrolled'] > 0): ?>
                                <a href="attack_<?php echo strtolower(str_replace(' ', '', $course['title'])); ?>.php" class="request-btn">Access Course</a>
                            <?php elseif ($loggedIn): ?>
