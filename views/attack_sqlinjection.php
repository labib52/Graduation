...
<body>
    ...
    <main class="content">
        <!-- Lecture Card -->
        <a href="/Graduation/views/lecture.php?id=31">
            <div class="simulation-card">
                <div class="simulation-header">
                    <h2>SQL Injection Lecture</h2>
                    <span class="status active">Active</span>
                </div>
                <p class="description">Learn about exploiting vulnerabilities in the SQL Injection to gain unauthorized access to Web networks and best practices to prevent such attacks.</p>
            </div>
        </a>

        <!-- Lab Exercises Card -->
        <a href="/Graduation/views/lab.php?id=12">
            <div class="simulation-card">
                <div class="simulation-header">
                    <h2>Lab Exercises</h2>
                    <span class="status active">Active</span>
                </div>
                <p class="description">Hands-on exercises to simulate and mitigate SQL Injection on Web networks.</p>
            </div>
        </a>
