...
<body>
    ...
    <main class="content">
        <!-- Lecture Card -->
        <a href="/Graduation/views/lecture.php?id=38">
            <div class="simulation-card">
                <div class="simulation-header">
                    <h2>DHCP Starvation Lecture</h2>
                    <span class="status active">Active</span>
                </div>
                <p class="description">Learn about DHCP Starvation attack and mitigation techniques.</p>
            </div>
        </a>

        <!-- Lab Exercises Card -->
        <a href="/Graduation/views/lab.php?id=16">
            <div class="simulation-card">
                <div class="simulation-header">
                    <h2>Lab Exercises</h2>
                    <span class="status active">Active</span>
