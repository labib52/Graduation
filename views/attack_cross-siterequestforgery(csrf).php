...
<body>
    ...
    <main class="content">
        <!-- Lecture Card -->
        <a href="/Graduation/views/lecture.php?id=35">
            <div class="simulation-card">
                <div class="simulation-header">
                    <h2>Cross-site request forgery (CSRF) Lecture</h2>
        ...
        <!-- Lab Exercises Card -->
        <a href="/Graduation/views/lab.php?id=20">
            <div class="simulation-card">
                <div class="simulation-header">
                    <h2>Lab Exercises</h2>
                    <span class="status active">Active</span>
       ...
       <a href="index.php" target="_blank">
        ...
        <!-- Back Button -->
        <a href="network.php" class="back-button">← Back</a>
    </main>
    <footer>
