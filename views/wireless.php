...
$courses = [];
if ($category_id !== null) {
    $query = $conn->prepare("SELECT id, title, description FROM courses WHERE category_id = ? AND title NOT LIKE 'attack_mitm_%'");
        ...
        <div class="simulations">
            ...
            <?php else: ?>
                <?php foreach ($courses as $course): ?>
                    <a href="/Graduation/views/attack_<?php echo strtolower(str_replace(' ', '_', $course['title'])); ?>.php">
