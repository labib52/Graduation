...
<head>
    ...
    <title>WEP Cracking Simulation</title>
    ...
    <main class="content">
        ...
        <a href="/Graduation/wirelessattack/attack_wep_cracking_lec.php">
            <div class="simulation-card">
                ...
                <p class="description">Learn how attackers exploit vulnerabilities in WEP encryption to gain unauthorized access and the best practices to avoid such breaches.</p>
            </div>
        </a>
        ...
        <a href="https://aircrack-ng.org/" target="_blank">
            <div class="simulation-card">
                ...
                <p class="description">Discover tools like Aircrack-ng for cracking WEP encryption and learn how to secure your network effectively.</p>
            </div>
        </a>
